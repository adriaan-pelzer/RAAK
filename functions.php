...
function create_post_type () {
    ...
    register_post_type('raak_product', array('labels' => array('name' => __('products'), 'singular' => __('product')), 'public' => TRUE, 'has_archive' => TRUE, 'rewrite' => array('slug' => 'raak-products'), supports => array('custom-fields', 'title', 'editor'), taxonomies => array('category')));
    register_post_type('raak_project', array('labels' => array('name' => __('projects'), 'singular' => __('project')), 'public' => TRUE, 'has_archive' => TRUE, 'rewrite' => array('slug' => 'raak-projects'), supports => array('custom-fields', 'title', 'editor'), taxonomies => array('category')));
}
