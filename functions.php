...
function insert_fb_in_head() {
    global $post;
    if ($post->post_type != 'post') //if it is not a post or a page
        return;
...
<?php echo $current_work_post_id; ?>
<?php print_r(get_post($work_post_array[$current_work_post_id])); ?>
</div>
<?php
 */
...
<?php
    ...
    $most_viewed = new WP_Query(array('orderby' => 'meta_value_num', 'meta_key' => 'postviews', 'posts_per_page' => 6, 'paged' => 1, 'post_type' => 'post'));
