...
function create_post_type () {
    ...
    register_post_type('raak_product', array('labels' => array('name' => __('products'), 'singular' => __('product')), 'public' => TRUE, 'has_archive' => TRUE, 'rewrite' => array('slug' => 'raak-products'), supports => array('custom-fields', 'title', 'editor', 'excerpt'), taxonomies => array('category', 'tag')));
    register_post_type('raak_project', array('labels' => array('name' => __('projects'), 'singular' => __('project')), 'public' => TRUE, 'has_archive' => TRUE, 'rewrite' => array('slug' => 'raak-projects'), supports => array('custom-fields', 'title', 'editor', 'excerpt'), taxonomies => array('category', 'tag')));
}
...
<?php
            $current_cat_loop = new WP_Query(array('category_name' => ($work_category->name), 'post_type' => 'raak_project', 'posts_per_page' => -1));
...
?>
    ...
    <div class="whitebox_big_all_items">
                    <!-- hr class="solid" -->
<?php
    $all_projects_loop = new WP_Query(array('post_type' => 'raak_project', 'posts_per_page' => -1));
