                            ...
                            <div class="whitebox_primary_content_founder_social">
                                ...
                                <div class="whitebox_primary_content_founder_social_right"> 
                                    <div class="whitebox_primary_content_founder_social_network social_linkedin">
                                        <span class="whitebox_primary_content_founder_social_linkedin_icon"><a href="' . echo get_post_meta($post-ID, "linkedin", TRUE) . '"><img src="' . echo bloginfo("template_url") . '/images/linked_in_icon.png" alt="LinkedIn"></a></span>
                                        <span class="whitebox_primary_content_founder_social_linkedin_text"><a href="' . echo get_post_meta($post-ID, 'linkedin', TRUE) . '">Linked In</a></span>
