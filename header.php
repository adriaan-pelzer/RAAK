...
<?php $current_page = get_page(); ?>

<body class="wordpress y2011 m12 d07 h07 <?php echo $current_page->post_title; ?> page pageid-4 page-author-admin page-template page-template-home-php">
