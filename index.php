...
<?php get_header() ?>
    ...
    <div class="container rounded-corners">
        <div class="content">
            ...
            <section id="bluebox_home_right" class="bluebox bluebox_primary box rounded-corners">
                ...
                <div class="whitebox whitebox_primary box rounded-corners">
                    <div id="whitebox_primary_body_post_0" class="whitebox_primary_body_post">
                        ...
                        <div class="whitebox_primary_body_post_attr">
                            ...
                            <span class="seperator">|</span-->
                            <span class="whitebox_primary_body_post_attr_item comments"><img class="commenticon" src="http://wewillraakyou.com/wp-content/themes/RAAK/images/whitebox_primary_body_post_attr_comment_icon.png" />0 comments</span>
                        </div><!-- .whitebox_primary_body_post_attr -->
                        <div class="whitebox_primary_body_content">
                            <p>
