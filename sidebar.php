<?php $what_others_have_said = get_page_by_title('What others have said about The RAAKonteur');
?>
        <div class="sidebar">
            <aside id="mailchimp">
                    ...
                    <div id="mc_embed_signup" style="font-family: 'helvetica neue', helvetica, arial, sans-serif;">
                        <form action="http://wewillraakyou.us1.list-manage.com/subscribe/post?u=898b1ec2bd8b50ddb10f7dfd0&amp;id=1c536f46e3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" style="font: normal 100% 'helvetica neue';font-size: 12px;">
	                        <fieldset style="-moz-border-radius: 4px;border-radius: 4px;-webkit-border-radius: 4px;border: 0px solid #000000;padding-top: 1.5em;margin: .5em 0;background-color: #FFFFFF;color: #333333;text-align: left;">
	                            ...
	                            <div style="font-family: 'helvetica neue', helvetica, arial, sans-serif;color: #FF0087;background: #CCCCCC;padding: .5em 1em;border: 1px solid #000000;-moz-border-radius: 4px;border-radius: 4px;-webkit-border-radius: 4px;font-size: 1.2em;text-align: center; overflow-x:auto;"><span style="color:#ffffff;">** <a href="<?php echo get_permalink($what_others_have_said->ID); ?>" style="color:#B9E5FB;text-decoration:none;">Read</a> what others have to say about The RAAKonteur</span></div>
                                ...
                                <div class="mc-field-group" style="margin: 1.3em 5%;clear: both;overflow: hidden;">
                                    <label for="mce-FNAME" style="display: block;margin: .3em 0;line-height: 1em;font-weight: bold;">First Name <strong class="note-required">*</strong></label>
                                ...
                                <div class="mc-field-group" style="margin: 1.3em 5%;clear: both;overflow: hidden;">
                                    <label for="mce-LNAME" style="display: block;margin: .3em 0;line-height: 1em;font-weight: bold;">Last Name <strong class="note-required">*</strong></label>
